...
export const AdminDashboard = () => {
  // State management for data, UI loading states, and filters
  ...
  // Consolidates multiple API calls into a single Promise.all for parallel fetching
  // This ensures the dashboard doesn't render partially
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Stats Cards Grid - Responsive layout (1 col mobile -> 4 cols desktop) */}
        ...
        {/* User Role Distribution - Visual progress bars for role metrics */}
